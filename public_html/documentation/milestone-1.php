...
<head>
    <meta charset="UTF-8">
    <title>Mary MacMillan</title>
</head>
<body>
    <h1>Mary MacMillan's PWP</h1>
    <h2>Purpose</h2>
    <p>I would like my PWP to act as a resume and as proof of my web development skills.</p>
    <h2>Audience</h2>
    ...
    <p>Dominic's goals while looking at my site are to find a gallery that shows off coding experience in a way that highlights both front and back end development skills. He wants to find a skilled, young developer who will fit in with the employees at his company and seems able to learn on the job.</p>
    <h3>User Story</h3>
    <p>As a user, I want to learn if this developer has the required skills to work at my company as a junior developer.</p>
</body>
</html>